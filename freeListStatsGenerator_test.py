...
def test_percent_when_heap_partial(mock_settings):
	...
	s = FreeListStatsGenerator(mock_settings, [n1, n2])
...
def test_average_node_size(mock_settings):
	...
	s = FreeListStatsGenerator(mock_settings, [n1, n2, n3])
