...
def test_reference_counts_are_maintained(settings):
	...
	write_barrier = RecyclerWriteBarrier(objects, rootset, free_list, settings)
...
def test_reference_count_increments_color_black(settings):
	o1 = HeapObject(0, 8)
	o2 = HeapObject(8, 8)
	...
	assert o2.color == 'black'

def test_reference_count_decrement_gt_one_color_purple(settings):
	o1 = HeapObject(0, 8)
	o2 = HeapObject(8, 8)
